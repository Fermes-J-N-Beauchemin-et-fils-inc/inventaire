...
export default function InventairePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] py-8 px-4 sm:px-8 text-black font-sans">
      <div className="max-w-[1500px] mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-zinc-300">
        ...
        <div className="bg-white px-8 pt-8 pb-6 border-b-2 border-zinc-200 flex flex-col xl:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap justify-center bg-zinc-100 p-1.5 rounded-xl border-2 border-zinc-300 shadow-inner gap-1">
            <button
              ...
              className={`px-5 py-3 rounded-lg text-sm sm:text-base font-black transition-all ${
                view === 'inventaire' 
            ...
            <button
              ...
              className={`px-5 py-3 rounded-lg text-sm sm:text-base font-black transition-all flex items-center gap-2 ${
                view === 'reception' 
                          ...
                          return (
                            <li key={delivery.id} className="p-4 sm:p-5 flex items-center justify-between hover:bg-blue-50 transition-colors">
                              <div className="flex items-center gap-5">
                                <div className={`w-14 h-14 rounded-xl flex flex-col items-center justify-center border-2 shadow-sm ${
                                  isPast ? 'bg-zinc-200 border-zinc-400 text-zinc-600' : 'bg-white border-zinc-300 text-black'
                                }`}>
                ...
                {deliveries.length === 0 ? (
                  ...
                  <form onSubmit={handleReceiveDelivery} className="space-y-6">
                          ...
                          {deliveries.map(d => {
                            ...
                            return (
                              <li 
                                ...
                                className={`p-4 sm:p-5 flex items-center justify-between cursor-pointer transition-colors border-l-8 ${
                                  isSelected 
                              ...
                              >
                                <div className="flex items-center gap-5">
                                  <div className={`w-14 h-14 rounded-xl flex flex-col items-center justify-center border-2 shadow-sm ${
                                    isSelected ? 'bg-blue-600 border-blue-700 text-white' : (isPast ? 'bg-zinc-200 border-zinc-400 text-zinc-600' : 'bg-white border-zinc-300 text-black')
                                  }`}>
                                    <span className="text-xs font-black uppercase">{dateObj.toLocaleDateString('fr-CA', { month: 'short' }).replace('.', '')}</span>
                                    <span className="text-xl font-black leading-none">{dateObj.getDate()}</span>
                                  </div>
                    ...
                    <button 
                      ...
                      className={`w-full py-5 font-black text-2xl rounded-xl shadow-lg transition-all border-b-4 ${
                        !selectedDeliveryId 
