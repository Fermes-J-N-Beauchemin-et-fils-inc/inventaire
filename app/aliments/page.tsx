...
import { faWheatAwn, faArrowRight, faBoxesStacked, faChartLine, faPlus, faSearch } from '@fortawesome/free-solid-svg-icons';

export default function AlimentsListPage() {
  return (
    <Sidenav>
      <div className="min-h-screen bg-[#FAF8F5] py-8 px-4 sm:px-8 font-sans">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-black text-lg px-8 py-4 rounded-2xl shadow-lg shadow-blue-600/30 hover:-translate-y-1 active:translate-y-0 transition-all border-b-4 border-blue-800 active:border-b-0 flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {mockAlimentsDetails.map((aliment) => {
              ...
              >
                ...
                <div className="space-y-2 mb-6">
                  <div className="flex justify-between text-sm font-bold">
                    ...
                    <span className="text-zinc-400">{Math.round(stockPercentage)}%</span>
                  </div>
